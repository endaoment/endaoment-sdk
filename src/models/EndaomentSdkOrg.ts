...
/**
 * Check if a given object implements the EndaomentSdkOrg interface.
 */
export function instanceOfEndaomentSdkOrg(value: object): boolean {
    let isInstance = true;
...
export function EndaomentSdkOrgFromJSON(json: any): EndaomentSdkOrg {
    return EndaomentSdkOrgFromJSONTyped(json, false);
}

export function EndaomentSdkOrgFromJSONTyped(json: any, ignoreDiscriminator: boolean): EndaomentSdkOrg {
...
export function EndaomentSdkOrgToJSON(value?: EndaomentSdkOrg | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
