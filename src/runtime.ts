...
export class Configuration {
  constructor(private configuration: ConfigurationParameters = { network: 'mainnet' }) {}
  ...
  get basePath(): string {
    switch (this.configuration.network) {
      case 'goerli':
        return 'https://api.staging.endaoment.org'
      case 'local':
        return 'http://localhost:3333'
      default:
        return 'https://api.endaoment.org'
    }
  }
